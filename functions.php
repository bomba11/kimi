...
define( 'CHILD_THEME_NAME', 'KIMI' );
define( 'CHILD_THEME_URL', 'https://fasterwp.com/downloads/kimi/' );
...
function genesis_sample_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'genesis-sample-fonts', '//fonts.googleapis.com/css?family=Roboto+Condensed:400,700|Merriweather:300', array(), CHILD_THEME_VERSION );
...
genesis_register_sidebar( array(
    'id' => 'after-header',
    'name' => __( 'After Header', 'genesis-sample' ),
    'description' => __( 'This is the after header before content section.', 'genesis-sample' ),
